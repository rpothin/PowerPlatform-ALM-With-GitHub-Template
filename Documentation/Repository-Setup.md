...
| environment </br> developmentEnvironment </br> developersAzureAdGroupName | Name of the Azure AD security group with the developers to add as a Azure AD security group team to the Dataverse Dev environment that will be created during workspace initialization phase | "sg-demoapplication-developers"            |
...
> - *Valid options for **skuName** configurations are: Trial, Sandbox, Production, SubscriptionBasedTrial (source [microsoft/powerplatform-actions/create-environment](https://github.com/microsoft/powerplatform-actions/blob/30b7cbe414cf675d173d8af70e06c1ed7eef10f3/create-environment/action.yml#L36))*
